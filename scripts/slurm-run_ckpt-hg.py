...
#SBATCH --mail-user=harsha84@uw.edu
...
python -u main_requeue_feco.py paths=hyak train.note={note} version=ckpt train={train} dataset={dataset} num_gpus={num_gpus} load_jobid={load_jobid} run_id=$SLURM_JOB_ID {override}
            """
...
def main():
    ...
    parser.add_argument('--train', type=str, default='train_fly_multiclip_feco_v2',
                        help='Name of train yaml (default: train_fly_multiclip_feco_v2)')
